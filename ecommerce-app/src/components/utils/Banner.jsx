...
const Banner = () => {
  return (
    <section className=" z-90 w-full my-2 flex items-center justify-center  h-[500px] px-auto py-10 bg-[url('./assets/images/man9.jpg');] bg-position  bg-cover object-cover bg-no-repeat md:bg-fit" style={{aspectRatio:1}} >
      <div className="">
