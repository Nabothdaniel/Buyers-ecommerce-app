...
export const Services = () => {
    const [cards,setCards] = useState([
        {
            id:1,
            icon:<BiCart className='icon-color w-5 h-5 mb-2'/>,
            title:'Free Delivery',
            body:'Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores.'
        },
        {
            id:2,
            icon:<BiTag className='icon-color w-5 h-5 mb-2'/>,
            title:'Quality Guarantee',
            body:'Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores.'
        },
        {
            id:3,
            icon:<BiRefresh className='icon-color w-5 h-5 mb-2'/>,
            title:'Daily Offers',
            body:'Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores.'
        },
        {
            id:4,
            icon:<BiShield className='icon-color w-5 h-5 mb-2'/>,
  ...
  return (
    <div className='services'>
      ...
      <h1 className="text-center text-2xl font-bold my-7">Services</h1>
        <div className="grid grid-cols-1 grid-rows-1 md:grid-cols-2 gap-5">
          {
            cards.map(card =>(
