...
export const Categories = () => {
  ...
  return (
    <div className='px-4 md:px-24 my-5 bg-slate-50 py-5  shadow-sm'>
      ...
      <div className="category-cards grid grid-cols-1 grid-rows-1 h-full md:grid-cols-2 gap-4 md:grid-rows-2">
          {
            category.map(singleCate =>(
              <div className={`category-card bg-[url('${img4}')] bg-center bg-contan w-full bg-fit bg-no-repeat rounded z-10 shadow-sm relative border border-gray-300 h-[10rem] my-3`} key={singleCate.id}>
