      ...
      <div className="category-cards grid grid-cols-1 grid-rows-1 md:grid-cols-2 gap-4 md:grid-rows-2">
          {
            category.map(singleCate =>(
              <div className="category-card bg-[url('assets/img2.jpg')] bg-top w-full bg-cover bg-no-repeat rounded shadow-sm relative border border-gray-300 h-[10rem] my-3" key={singleCate.id}>
