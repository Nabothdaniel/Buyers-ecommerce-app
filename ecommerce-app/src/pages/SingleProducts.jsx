                            ...
                            <div className=''>
                                ...
                                <div>
                                    ...
                                    <input type='number'  onChange={(e)=> e.target.value} className='border-none py-2 text-black border-2 focus:border-red-500  px-4 mb-2 w-full outline-none'/>
                                        ...
                                        <button className='border-2 border-gray-300 outline-none text-sm  font-semibold py-2 px-3 rounded-md max-w-full w-full my-2 bg-cyan-500  flex justify-center items-center text-white gap-2 focus:border-cyan-400'>
                                            <p className='text-xl text-white'>Add to cart</p>
                                            <FaArrowAltCircleRight  className='h-5 w-5 mt-[0.2rem] '/>
                                        </button>
                                    </div>
                                </div>
                            </div>
